...
/* harmony import */ var _letter_by_letter_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./letter-by-letter-animation */ "./source/js/modules/letter-by-letter-animation.js");
  ...
  changeVisibilityDisplay() {
    ...
    if (!activeScreen.classList.contains(`animation-letter-done`)) {
      ...
      for (let i = 0; i < lettersAnimationElements.length; i++) {
        lettersAnimationElements[i].innerHTML = Object(_letter_by_letter_animation__WEBPACK_IMPORTED_MODULE_1__["default"])(lettersAnimationElements[i], activeScreen);
      }
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = ((animationTextElement, activeScreen) => {
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        targetEl[0].classList.add(`screen--active`);
